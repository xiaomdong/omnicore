...
void static NewcoinMiner(const CChainParams& chainparams)
{
    return;
#if 0
    LogPrintf("RBTCMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("rbtc-miner");
...
void GenerateNewcoins(bool fGenerate, int nThreads, const CChainParams& chainparams)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&NewcoinMiner, boost::cref(chainparams)));
}
