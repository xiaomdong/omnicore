...
CMainConsensusParams::CMainConsensusParams()
{
    ...
    exodusDeadline = 1535684034;
    exodusReward = 100;
    GENESIS_BLOCK = 160;
    LAST_EXODUS_BLOCK = 1080;
    ...
    MSC_DEX_BLOCK = 180;
    MSC_SP_BLOCK = 190;
    MSC_MANUALSP_BLOCK = 220;
    MSC_STO_BLOCK = 230;
    MSC_METADEX_BLOCK = 300;
    MSC_SEND_ALL_BLOCK = 290;
    MSC_BET_BLOCK = 999999;
    MSC_STOV1_BLOCK = 999999;
    // Other feature activations:
    GRANTEFFECTS_FEATURE_BLOCK = 285;
    DEXMATH_FEATURE_BLOCK = 285;
    SPCROWDCROSSOVER_FEATURE_BLOCK = 285;
    TRADEALLPAIRS_FEATURE_BLOCK = 320;
